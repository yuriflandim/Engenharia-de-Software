...
<html>
    <head>
        ...
        <!-- Ionicons 2.0.0 -->
        <link href="assets/css/fonts/ionicons.min.css" rel="stylesheet" type="text/css" />    
        <!-- Theme style -->
        <link href="assets/css/AdminLTE.css" rel="stylesheet" type="text/css" />
        
        <link href="assets/css/custom.css" rel="stylesheet" type="text/css" />
        
        <link href="assets/css/skin-default.css" rel="stylesheet" type="text/css" />
        ...
        <!-- pnotify -->
        <link rel="stylesheet" href="assets/plugins/pnotify/jquery.pnotify.default.css">
        <link rel="stylesheet" href="assets/plugins/pnotify/jquery.pnotify.default.icons.css">
        
        <!-- Sortable -->
        <link href="assets/plugins/sortable/style.css" rel="stylesheet">
        
        <!-- Steps -->
        <link href="assets/plugins/steps/jquery.steps.css" rel="stylesheet" type="text/css" />
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/base">
                                <i class="fa fa-dashboard"></i> <span>Base</span></i>
                            </a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/operador">
